...
print("Test accuracy is: ",(cm[0][0]+cm[1][1])/2000)
...
accurecies = cross_val_score(estimator = classifier, X = X_train, y = y_train , cv = 10 , n_jobs = -1)
mean=accurecies.mean()
variance = accurecies.std()
